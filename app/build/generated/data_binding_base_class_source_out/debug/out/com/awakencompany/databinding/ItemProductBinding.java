...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull MaterialCardView rootView,
      @NonNull MaterialButton btnAddToCart, @NonNull TextView tvCategory,
      @NonNull TextView tvItemCode, @NonNull TextView tvItemName, @NonNull TextView tvPrice,
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((MaterialCardView) rootView, btnAddToCart, tvCategory,
          tvItemCode, tvItemName, tvPrice, tvStock);
    }
